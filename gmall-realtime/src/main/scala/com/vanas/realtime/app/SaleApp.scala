...
import com.vanas.realtime.bean.{OrderDetail, OrderInfo, SaleDetail, UserInfo}
import com.vanas.realtime.util.{ESUtil, MyKafkaUtil, RedisUtil}
...
object SaleApp extends BaseApp {
    ...
    def joinUser(saleDetailStream: DStream[SaleDetail], ssc: StreamingContext) = {
        ...
        val url = "jdbc:mysql://hadoop102:3306/gmall_realtime?useSSL=false"
        ...
        saleDetailStream.transform(rdd => {
            ...
            //2.saleDetail编程，然后和User join补齐user信息
